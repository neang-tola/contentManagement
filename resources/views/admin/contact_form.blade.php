                ...
                <section class="panel">
                  ...
                  <div class="panel-body">
                    <div class="form">
                        ...
                        {!! Form::open(['url' => route('admin.contact.update'), 'class' => 'form-validate form-horizontal', 'id' => 'form_article',  'onsubmit' => 'return isValidate_form_article()']) !!}
                          @if($info_translate['lang_count'] == 1)
                              <div class="form-group">
                                  ...
                                  @foreach($info_translate['lang_info'] as $lang_val)
                                      ...
                                      <input type="hidden" name="articleTId[]" value="1" />
                          ...
                          @endif
                                      <div class="form-group">
                                          <label for="articleShowFront" class="control-label col-lg-2 col-md-4 col-sm-4">Address on map (Google Map) </label>
                                          <div class="col-lg-10 col-md-8 col-sm-8">
                                              <input type="text" name="articleMap" class="form-control" value="{{ $info->con_remark }}" />
                                          </div>
                                      </div>
                                      <div class="form-group">
