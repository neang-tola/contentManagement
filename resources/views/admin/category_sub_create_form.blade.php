                ...
                <section class="panel">
                  ...
                  <div class="panel-body">
                    <div class="form">
                        ...
                        {!! Form::open(['url' => route('admin.subcategory.insert'), 'class' => 'form-validate form-horizontal', 'id' => 'form_sub_category',  'onsubmit' => 'return isValidate_form_category()', 'files' => true]) !!}
                          @if($info_translate['lang_count'] == 1)
                              <div class="form-group">
                                  <label for="categoryTitle" class="control-label col-lg-2 col-md-4 col-sm-4">Sub-category Title <span class="required">*</span></label>
                                  <div class="col-lg-6 col-md-4 col-sm-4">
                                  @foreach($info_translate['lang_info'] as $lang_val)
                                      <input type="hidden" name="langId[]" value="{{ $lang_val->lang_id }}" />
                                      <input class="form-control" id="categoryTitle" name="categoryTitle[]" type="text" value="" />
                                  @endforeach
                                  </div>
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-lg-10 col-md-8 col-sm-8">
                                      <textarea class="form-control categoryDes" id="categoryDes" name="categoryDes[]" ></textarea>
                                  </div>
                              </div>
                          @else
                              <div class="form-tab">
                                    ...
                                    $print_content .= '
                                                <div id="tab-'. strtolower(@$lang_val->lang_title) .'" class="tab-pane">
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <div class="col-lg-10 col-md-8 col-sm-8">
                                                        <textarea class="form-control categoryDes" name="categoryDes[]" ></textarea>
                                                    </div>
                                                  </div>
                                                </div>';
                                  }
                          ...
                          @endif
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-lg-6 col-md-4 col-sm-4">
                                              {!! Form::select('categoryStatus', AdminHelper::controlStatus(), 0, ['class' => 'form-control', 'id' => 'categoryStatus']) !!}
                                          </div>
                                      </div>
                                      <div class="form-group">
                                          <label for="categoryOrder" class="control-label col-lg-2 col-md-4 col-sm-4">Order <span class="required">*</span></label>
                                          <div class="col-lg-6 col-md-4 col-sm-4">
                                              {!! Form::text('categoryOrder', $max_order, ['class' => 'form-control', 'id' => 'categoryOrder']) !!}
                                          </div>
