                ...
                <section class="panel">
                  ...
                  <div class="panel-body">
                    <div class="form">
                        ...
                        {!! Form::open(['url' => route('admin.category.insert'), 'class' => 'form-validate form-horizontal', 'id' => 'form_category',  'onsubmit' => 'return isValidate_form_category()', 'files' => true]) !!}
                          ...
                          @endif
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-lg-6 col-md-4 col-sm-4">
                                              {!! Form::select('categoryShowFront', AdminHelper::controlYesNo(), 0, ['class' => 'form-control', 'id' => 'categoryShowFront']) !!}
                                          </div>
                                      </div>
                                      <div class="form-group">
