                ...
                <section class="panel">
                  ...
                  <div class="panel-body">
                    <div class="form">
                        ...
                        {!! Form::open(['url' => route('admin.category.update'), 'class' => 'form-validate form-horizontal', 'id' => 'form_category',  'onsubmit' => 'return isValidate_form_category()', 'files' => true]) !!}
                          @if($info_translate['lang_count'] == 1)
                              <div class="form-group">
                                  ...
                                  @foreach($info_translate['lang_info'] as $lang_val)
                                      ...
                                      <input type="hidden" name="categoryTId[]" value="{{ $lang_val->catt_id }}" />
                                      <input class="form-control" id="categoryTitle" name="categoryTitle[]" type="text" value="{{ $lang_val->catt_title }}" />
                                  @endforeach
                                  </div>
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-lg-10 col-md-8 col-sm-8">
                                      <textarea class="form-control categoryDes" id="categoryDes" name="categoryDes[]" >{{ @$lang_val->catt_des }}</textarea>
                                  </div>
                              </div>
                          @else
                              <div class="form-tab">
                                                ...
                                                <div id="tab-'. strtolower(@$lang_val->lang_title) .'" class="tab-pane">
                                                  <div class="form-group">
                                                    ...
                                                    <div class="col-lg-6 col-md-4 col-sm-4">
                                                        <input type="hidden" name="langId[]" value="'. @$lang_val->lang_id .'" />
                                                        <input type="hidden" name="categoryTId[]" value="'. @$lang_val->catt_id .'" />
                                                        <input class="form-control" name="categoryTitle[]" type="text" value="'.@$lang_val->catt_title.'" />
                                                    </div>
                                                  </div>
                                                  <div class="form-group">
                                                    <label for="categoryDes" class="control-label col-lg-2 col-md-4 col-sm-4"> Description </label>
                                                    <div class="col-lg-10 col-md-8 col-sm-8">
                                                        <textarea class="form-control categoryDes" name="categoryDes[]" >' .@$lang_val->catt_des .'</textarea>
                                                    </div>
                                                  </div>
                                                </div>';
                                  }
                          ...
                          @endif
                                      <div class="form-group">
                                          ...
                                          <div class="col-lg-4 col-md-4 col-sm-4">
                                              <input type="hidden" name="categoryId" value="{{ $info->cat_id }}" /> 
                                              @if(!empty($info->cat_image))
                                                <img src="/public/categories/{{ $info->cat_image }}" height="35px" />
                                              @endif
                                          </div>
                                      </div>                          
                                      <div class="form-group">
                                          <label for="categoryShowFront" class="control-label col-lg-2 col-md-4 col-sm-4">Show front page status </label>
                                          <div class="col-lg-6 col-md-4 col-sm-4">
                                              {!! Form::select('categoryShowFront', AdminHelper::controlYesNo(), $info->cat_front, ['class' => 'form-control', 'id' => 'categoryShowFront']) !!}
                                          </div>
                                      </div>
                                      <div class="form-group">
                                          <label for="categoryStatus" class="control-label col-lg-2 col-md-4 col-sm-4">Category Status </label>
                                          <div class="col-lg-6 col-md-4 col-sm-4">
                                              {!! Form::select('categoryStatus', AdminHelper::controlStatus(), $info->cat_status, ['class' => 'form-control', 'id' => 'categoryStatus']) !!}
                                          </div>
                                      </div>
                                      <div class="form-group">
                                          <label for="categoryOrder" class="control-label col-lg-2 col-md-4 col-sm-4">Order <span class="required">*</span></label>
                                          <div class="col-lg-6 col-md-4 col-sm-4">
                                              {!! Form::text('categoryOrder', $info->cat_sequense, ['class' => 'form-control', 'id' => 'categoryOrder']) !!}
                                          </div>
                                          <div class="col-lg-4 col-md-4 col-sm-4">
